<?php
  ...
  if(isset($_POST['btnEntrar']))
  {
    ...
    $sql = "select senha from USUARIOS where email = '$_POST[email]' and tipo = 'E'";
...
<body>
    ...
    <main role="main" class="container">
        ...
        <!--Formulário de login-->
        <form class="col-sm-4 offset-md-4" action="login_empresa.php" method="POST">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm">
                        <a class='btn btn-primary' href='cadastrar_empresa.php' role='button'>Cadastre-se</a>
                    </div>
                </div>
            </div>
        </form>
