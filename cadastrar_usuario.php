...
<html lang="pt">
  ...
  <body>
    ...
    <main role="main" class="container">
      ...
      <form class="col-sm-6 offset-md-4" action="insert_usuario.php" method="POST">
        <div class="form-row">
            ...
            <input type="text" class="form-control" id="validationEndereco" name="endereco" placeholder="Endereço" value="" required>
			    ...
			    <div class="col-md-10 mb-3">
				    <label for="validationTelefone">Número Telefone:</label>
            <input type="text" maxlength="11" class="form-control" id="validationTelefone" name="telefone" placeholder="Telefone" value="" required>
          </div>
        </div>
        <label for="InputSexo">Sexo:&nbsp;&nbsp;</label>
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="sexo" id="RadioMasc" value="M" value="" checked="checked">
